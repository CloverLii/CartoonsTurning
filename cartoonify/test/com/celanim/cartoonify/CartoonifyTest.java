...
public class CartoonifyTest {
	...
	public void testConvolutionCentre() throws IOException {
		...
		assertEquals(0, cart.convolution(2, 2, Cartoonify.GAUSSIAN_FILTER)[1]);
		assertEquals(255 * 159, cart.convolution(2, 2, Cartoonify.GAUSSIAN_FILTER)[0]);
		assertEquals(255 * 142, cart.convolution(2, 3, Cartoonify.GAUSSIAN_FILTER)[0]);
		assertEquals(255 * 104, cart.convolution(2, 4, Cartoonify.GAUSSIAN_FILTER)[0]);
	}
	...
	public void testConvolutionXAxis() throws IOException {
		...
		for (int x = -3; x <= 3; x++) {
			assertEquals(255 * 55, cart.convolution(x, 24, Cartoonify.GAUSSIAN_FILTER)[0]);
		}
	}
	...
	public void testConvolutionYAxis() throws IOException {
		...
		// go along the black line over the zero edge.
		for (int y = -3; y <= 3; y++) {
			assertEquals(255 * 110, cart.convolution(29, y, Cartoonify.GAUSSIAN_FILTER)[0]);
		}
	}
